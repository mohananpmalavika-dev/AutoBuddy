...
const PRODUCTS = [
  ...
  { key: 'intercity', icon: '🛣️', title: 'Intercity', sub: 'City-to-city rides' },
  { key: 'ev_auto', icon: '🔋', title: 'EV Auto', sub: 'Electric auto rides' },
  { key: 'tourism', icon: '🌴', title: 'Tourism', sub: 'Ride + guide packages' },
  { key: 'women_only', icon: '🛡️', title: 'Women Only', sub: 'OTP + guardian safety' },
